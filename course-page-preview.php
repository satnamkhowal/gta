<?php
/**
 * Groot Academy course page preview.
 * Purpose: approve the new course-page design before rolling it out to live course URLs.
...
<head>
    <meta charset="utf-8">
    <title>Course Page Design Preview | Groot Academy Jaipur</title>
    <meta name="description" content="Preview of the new Groot Academy course-page design for Python Full Stack training in Jaipur.">
    <meta name="robots" content="noindex, nofollow, noarchive">
    <?php include("head.php"); ?>
    <link rel="stylesheet" type="text/css" href="assets/css/groot-course-page.css">
</head>

<body class="defult-home ga-course-page">
