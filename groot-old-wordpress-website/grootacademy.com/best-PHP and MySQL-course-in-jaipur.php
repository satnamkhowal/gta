...
<div class="container mt-5">
    <div class="row">
        ...
        <link href="./assets2/css/nucleo-svg.css" rel="stylesheet" /><link href="./assets2/css/soft-design-system.min.css" rel="stylesheet" /><!-- -------- START Features w/ icons and text on left & gradient title and text on right -------- -->
<section class="py-3">
  <div class="container">
    <div class="row">
      <div class="col-lg-12">
...
<section class="py-3">
  <div class="container">
    <div class="row">
      <div class="col-lg-12">
        <h3 class="text-gradient text-primary mb-0 mt-2">PHP (Hypertext Preprocessor):</h3>
        <br/><br/>
        <h6>PHP is a server-side scripting language designed for web development. It is embedded in HTML and executed on the web server, generating dynamic content that is then sent to the client web browser. Key features of PHP include</h6>
        <ul >
...
<!-- -------- END Features w/ icons and text on left & gradient title and text on right -------- -->
      ...
      <section class="py-3">
        <div class="container">
          <div class="row">
            <div class="col-lg-12">
              <h3 class="text-gradient text-primary mb-0 mt-2">Server-Side Scripting:</h3>
              <br/><br/>
              <h6>PHP scripts are executed on the web server, allowing you to generate dynamic web pages and handle various tasks before sending the content to the user browser.</h6>
      ...
      <section class="py-3">
        <div class="container">
          <div class="row">
            <div class="col-lg-12">
              <h3 class="text-gradient text-primary mb-0 mt-2">Embedding in HTML:</h3>
              <br/><br/>
              <h6>PHP code can be embedded directly into HTML, making it easy to mix dynamic content with static HTML markup</h6>
...
<br/><br/>
<h6>PHP is available on multiple platforms, including Windows, macOS, and various Unix-like operating systems.</h6>
...
<div class="row">
<div class="col-lg-12">
<h3 class="text-gradient text-primary mb-0 mt-2">Extensive Library Support:</h3>
<br/><br/>
<h6>PHP has a rich ecosystem of built-in functions and libraries that simplify tasks such as file handling, database interaction, and more.</h6>
...
<br/><br/>
<h6>PHP is often used to create web applications, including content management systems (CMS), e-commerce platforms, and web-based software.</h6>
...
<div class="row">
<div class="col-lg-12">
<h3 class="text-gradient text-primary mb-0 mt-2">Frameworks:
</h3>
<br/><br/>
<h6>Popular PHP frameworks like Laravel, Symfony, and CodeIgniter provide structured approaches to building web applications, promoting code organization and best practices.</h6>
...
<div class="row">
<div class="col-lg-12">
<h3 class="text-gradient text-primary mb-0 mt-2">Relational Database:
</h3>
<br/><br/>
<h6>MySQL stores data in tables with predefined relationships between them, allowing for efficient storage and retrieval of information.
</h6>
...
<div class="row">
<div class="col-lg-12">
<h3 class="text-gradient text-primary mb-0 mt-2">SQL (Structured Query Language):
</h3>
<br/><br/>
<h6>MySQL uses SQL to manage and manipulate data. SQL allows you to create, retrieve, update, and delete data in the database.</h6>
...
<div class="row">
<div class="col-lg-12">
<h3 class="text-gradient text-primary mb-0 mt-2">Performance:
</h3>
<br/><br/>
<h6>MySQL is optimized for high-performance database operations and can handle a large number of concurrent users and transactions.</h6>
...
<div class="row">
<div class="col-lg-12">
<h3 class="text-gradient text-primary mb-0 mt-2">Data Security:
</h3>
<br/><br/>
<h6>MySQL provides security features like user authentication, encryption, and access control to protect sensitive data.</h6>
...
<div class="row">
<div class="col-lg-12">
<h3 class="text-gradient text-primary mb-0 mt-2">Community and Support:
</h3>
<br/><br/>
<h6>MySQL has a large and active community, providing resources, tutorials, and support for developers and administrators.</h6>
...
<div class="row">
<div class="col-lg-12">
<h3 class="text-gradient text-primary mb-0 mt-2">Scalability:</h3>
<br/><br/>
<h6>MySQL can be scaled to handle large amounts of data and high traffic by implementing techniques like replication and sharding.
</h6>
