        ...
        <div class="row clearfix">
            ...
            <div class="image-column col-lg-5 md-mb-50">
                <div class="inner-column mb-50 md-mb-0">
                    <div class="image">
                        <img src="<?php echo FINAL_WEBSITE_URL; ?>assets/images/team/Sandeep_sir.jpg" alt="" />
                    </div>
                    <div class="team-content text-center">
                        ...
                        <ul class="personal-info">
                            <li class="email">
                                ...
                                <a href="mailto:Sandeep@grootacademy.com">Sandeep@grootacademy.com</a>
                            </li>
                            <li class="phone">
                    ...
                    <div class="social-box">
                        ...
                        <a href="https://twitter.com/Sandeepkhowal" target="_blank" class="fa fa-twitter-square"></a>
                        <a href="https://www.linkedin.com/in/Sandeepkhowal/" target="_blank" class="fa fa-linkedin-square"></a>
                        <a href="https://github.com/Sandeepkhowal" target="_blank" class="fa fa-github"></a>
                    </div>
                </div>
            </div>
            <!-- Content Section -->
            <div class="content-column col-lg-7 pl-60 pt-50 md-pl-15 md-pt-0">
                <div class="inner-column">
                    ...
                    <h5>About Sandeep Sir</h5>
                    <p>Sandeep Swami, a distinguished Software Architect with an impressive tenure of 10 years in the tech industry, stands as a guiding force in the realm of software development. Currently spearheading innovation as Chief Instructor & Trainer at Groot Academy, Sandeep's journey is a testament to his unwavering commitment to technological advancement and education</p>
            ...
            <div class="col-lg-12">
                <div class="content-part">
                    ...
                    <p>With a decade-long journey in software architecture, Sandeep has accumulated a wealth of experience that spans various domains and industries. His proficiency in conceptualizing, designing, and implementing robust software solutions has not only earned him acclaim but also fueled his passion for cultivating the next generation of tech enthusiasts.
                    </p>
                </div>
                <div class="content-part">
                    <h3 class="title">Pioneering Education at Groot Academy:</h3>
                    <p>As the Chief Instructor & Trainer at Groot Academy, Sandeep embodies the fusion of practical expertise and educational prowess. His role extends beyond imparting knowledge; it's about inspiring learners to excel, innovate, and conquer challenges in the ever-evolving tech landscape.
                    </p>
                </div>
                <div class="content-part">
                    <h3 class="title">Driving Innovation:</h3>
                    <p>Sandeep's expertise extends across a spectrum of programming languages, technologies, and architectural paradigms. His ability to translate complex concepts into comprehensible learning experiences empowers students to bridge the gap between theory and application, nurturing a generation of well-rounded professionals.
                    </p>
                </div>
                <div class="content-part">
                    <h3 class="title">A Beacon of Inspiration:</h3>
                    <p>Sandeep's journey is a testament to the possibilities that unfold when innovation, determination, and education intersect. He envisions a future where technology is a force for good, and his role at Groot Academy is a conduit to realize this vision.
                    </p>
                </div>
                <div class="content-part">
                    <h3 class="title">Join the Journey:</h3>
                    <p>For those seeking to learn from an industry stalwart, Sandeep Swami's guidance offers a transformative path. Whether you're an aspiring developer, an established professional, or simply someone passionate about technology, his commitment to excellence and education awaits your journey of growth and achievement.</p>
                </div>
                <div class="content-part">
                    <h3 class="title">Connect with Sandeep: </h3>
                    <p>Feel free to connect with Sandeep Swami to explore the realms of software architecture, education, and the profound impact of merging technology with human ingenuity.</p>
                </div>
            </div>
        </div>
    </div>
