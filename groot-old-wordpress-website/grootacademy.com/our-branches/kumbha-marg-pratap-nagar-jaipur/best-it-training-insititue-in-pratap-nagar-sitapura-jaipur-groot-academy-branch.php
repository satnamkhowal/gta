      ...
      <div class="row justify-content-center">
        <div class="col-lg-8 text-center mx-auto my-auto">
          ...
          <div class="d-flex justify-content-center">
            <a class="nav-link pe-1" href="https://facebook.com/grootAcademy" target="_blank"><i class="fa fa-facebook text-lg text-white me-4"></i></a>
            <a class="nav-link pe-1" href="https://instagram.com/grootAcademy" target="_blank"><i class="fa fa-instagram text-lg text-white me-4"></i></a>
            <a class="nav-link pe-1" href="https://twitter.com/grootAcademy" target="_blank"><i class="fa fa-twitter text-lg text-white me-4"></i></a>
            <a class="nav-link pe-1" href="https://www.grootacademy.com/" target="_blank"><i class="fa fa-google-plus text-lg text-white"></i></a>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="row justify-content-start">
          <div class="col-md-6">
            <div class="info">
              ...
              <h5>Educate</h5>
              <p>Education is a purposeful activity directed at achieving certain aims, such as transmitting knowledge or fostering skills and character traits.</p>
            </div>
          </div>
          <div class="col-md-6">
            <div class="info">
              ...
              <h5>Practice</h5>
              <p>Level up your programming skills with our comprehensive guide containing interview questions, practice problems, coding challenges and alot more.</p>
            </div>
          </div>
        </div>
        <div class="row justify-content-start">
          <div class="col-md-6">
            <div class="info">
              ...
              <p>Implementation is often used in the tech world to describe the interactions of elements in programming languages. </p>
            </div>
          </div>
          <div class="col-md-6">
            <div class="info">
