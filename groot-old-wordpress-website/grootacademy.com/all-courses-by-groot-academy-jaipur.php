...
stack Web development with python Django , Full stack Web development with PHP, Data Analitics, Data Science, Machine Learning, Artificial Intelligence Data Engineer in Jaipur, Rajasthan,.100% Job Placement.</p>
">
<meta property="og:image" content="https://grootacademy.com/assets2/img/groot.png">
...
<header class="header-2">
    <div class="page-header min-vh-75 relative" style=" background-image: linear-gradient(310deg, #0c4e99 30%, #0c4e99 50%);">
        <div class="container">
            <div class="row">
        ...
        <div class="row align-items-center">
            <div class="col-lg-4 ms-auto me-auto p-lg-4 mt-lg-0 mt-4">
                <div class="card card-background card-background-mask-primary tilt" data-tilt>
                    <div class="full-background" style="background-image: url('./assets2/img/team-working.jpg')"></div>
    ...
    <div class="container">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-2 ms-auto me-auto p-lg-2  mt-1">
                    <div class="card  card-background-mask-primary tilt" data-tilt style="background-image: linear-gradient(310deg, #0c4e99 50%, #0c4e99 50%);">
                        ...
                        <div class="card-body pt-3 text-center">
                            ...
                            <h2 class="text-white mt-3"> Practical</h2>
                ...
                <div class="col-lg-3 ms-auto me-auto p-lg-1  mt-1">
                    <div class="card  card-background-mask-primary tilt" data-tilt style="background-image: linear-gradient(310deg, #0c4e99 50%, #0c4e99 50%);">
                        <div class="full-background" style="background-image: url('./assets2/img/logo.jpg')"></div>
                        <div class="card-body pt-4 text-center">

                            <h2 class="text-white mt-3"> Assignments</h2><br>

                        </div>
                    </div>

                </div>
                <div class="col-lg-3 ms-auto me-auto p-lg-2  mt-1">
                    <div class="card  card-background-mask-primary tilt" data-tilt style="background-image: linear-gradient(310deg, #0c4e99 50%, #0c4e99 50%);">
                        <div class="full-background" style="background-image: url('./assets2/img/logo.jpg')"></div>
                        <div class="card-body pt-4 text-center">

                            <h2 class="text-white mt-3">Certifications</h2>
                ...
                <div class="col-lg-5 ms-auto me-auto p-lg-2  mt-1">
                    <div class="card  card-background-mask-primary tilt" data-tilt style="background-image: linear-gradient(310deg, #0c4e99 50%, #0c4e99 50%);">
                        <div class="full-background" style="background-image: url('./assets2/img/logo.jpg')"></div>
                        <div class="card-body pt-0 text-center">

                            <h2 class="text-white mt-3">Resume and interview training</h2>

                        </div>
                    </div>

                </div>
                <div class="col-lg-7 ms-auto me-auto p-lg-2 mt-1">
                    <div class="card  card-background-mask-primary tilt" data-tilt style="background-image: linear-gradient(310deg, #0c4e99 50%, #0c4e99 50%);">
                        <div class="full-background" style="background-image: url('./assets2/img/logo.jpg')"></div>
                        <div class="card-body pt-0 text-center">

                            <h2 class="text-white mt-3">Got placement in Top MNC's and Product Based Companies</h2>
                ...
                <div class="row">
                    <div class="col-md-4 col-xs-6 col-sm-6 mt-md-0">
                        <a href="./programming-courses-after-10th-class">
                            <div class="card shadow-lg move-on-hover min-height-160 min-height-160">
                                ...
                                <b style="text-align: center; font-size:medium;margin-top:0px;">Software Engineering </b>
                    ...
                    <div class="col-md-4 col-xs-6  col-sm-6 mt-md-0">
                        <a href="./programming-or-coding-course-after-12th">
                            <div class="card shadow-lg move-on-hover min-height-160 min-height-160">
                                <img src="assets2/img/course-card-images/software-engineering-chart-with-keywords-and-icons-sketch-G2NGCM.jpg" width="100%">
                                <b style="text-align: center; font-size:medium;margin-top:5px;">Software Engineering</b>
                                <div class="mt-n1">
                    ...
                    <div class="col-md-4  col-sm-6 col-xs-6 mt-md-0">
                        <a href="./our-internship-programmes">
                            <div class="card shadow-lg move-on-hover min-height-160 min-height-160">
                                <img src="./assets2/img/course-card-images/intenship-programme.png" width="90%" height="75%">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-6 mt-md-0">
                        <a href="./best-web-designing-course-in-jaipur">
                            <div class="card shadow-lg move-on-hover min-height-160 min-height-160">
                                <img src="./assets2/img/course-card-images/web desiging-card2.png" width="100%">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-6 mt-md-0">
                        <a href="./best-front-end-development-course-with-react-js-in-jaipur">
                            <div class="card shadow-lg move-on-hover min-height-160 min-height-160">
                                <img src="./assets2/img/course-card-images/react js logo.png" width="100%">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-6 mt-md-0">
                        <a href="./best-full-stack-web-development-course-in-jaipur">
                            <div class="card shadow-lg move-on-hover min-height-160 min-height-160">
                                <img src="./assets2/img/groot-tech-logos/Full-Stack-Web-Developer-by-groot-academy.png" width="100%">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-6 mt-md-0">
                        <a href="./best-course-for-back-end-development-with-Java">
                            <div class="card shadow-lg move-on-hover min-height-160 min-height-160">
                                <img src="./assets2/img/groot-tech-logos/develop-a-backend-for-your-project-in-java-by-groot-academy.png" width="100%">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-6 mt-md-0">
                        <a href="./best-back-end-development-course-with-php-in-jaipur">
                            <div class="card shadow-lg move-on-hover min-height-160 min-height-160">
                                <img src="./assets2/img/course-card-images/php1 image.png" width="100%">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-6 mt-md-0">
                        <a href="./best-course-back-end-development-with-nodejs-in-jaipur">
                            <div class="card shadow-lg move-on-hover min-height-160 min-height-160">
                                <img src="./assets2/img/course-card-images/nodejs-course-card2.jpg" width="100%">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-6 mt-md-0">
                        <a href="./best-advance-java-course-in-jaipur">
                            <div class="card shadow-lg move-on-hover min-height-160 min-height-160">
                                <img src="./assets2/img/groot-tech-logos/servlet-and-jsp-advance-java-logo-by-groot-academy.jpg" width="100%">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-6 mt-md-0">
                        <a href="./best-data-structure-course-and-algorithms-in-jaipur">
                            <div class="card shadow-lg move-on-hover min-height-160 min-height-160">
                                <img src="./assets2/img/course-card-images/data structure.webp" width="100%">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-6 mt-md-0">
                        <a href="./best-python-programming-course-in-jaipur">
                            <div class="card shadow-lg move-on-hover min-height-160 min-height-160">
                                <img src="./assets2/img/groot-tech-logos/Python-programming-logo-by-groot-academy.jpg" width="100%">
                                <b style="text-align: center; font-size:medium; margin-top:65px;">Python</b>
                            </div>
                            <div class="mt-2 ms-2">
                            </div>
                        </a>
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-6 mt-md-0">
                        <a href="./best-c-plus-plus-programming-course-in-jaipur">
                            <div class="card shadow-lg move-on-hover min-height-160 min-height-160">
                                <img src="./assets2/img/course-card-images/c&c++ images.jpeg" width="100%">
                                <b style="text-align: center; font-size:medium; margin-top:27px;">C++</b>
                            </div>
                            <div class="mt-2 ms-2">
                            </div>
                        </a>
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-6 mt-md-0">
                        <a href="./best-c-programming-course-in-jaipur">
                            <div class="card shadow-lg move-on-hover min-height-160 min-height-160">
                                <img src="./assets2/img/course-card-images/C-programing.jpg" width="100%">
                                <b style="text-align: center; font-size:medium; margin-top:22px;">C</b>
                            </div>
                            <div class="mt-2 ms-2">
                            </div>
                        </a>
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-6 mt-md-0">
                        <a href="./best-spring-boot-course-in-jaipur">
                            <div class="card shadow-lg move-on-hover min-height-160 min-height-160">
                                <img src="./assets2/img/groot-tech-logos/spring-boot-logo-by-groot-academy.png" width="100%">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-6 mt-md-0">
                        <a href="./course-spring-mvc">
                            <div class="card shadow-lg move-on-hover min-height-160 min-height-160">
                                <img src="./assets2/img/groot-tech-logos/groot-academy-spring-mvc-logo.png" width="100%">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-6 mt-md-0">
                        <a href="./best-spring-framework-course-in-jaipur">
                            <div class="card shadow-lg move-on-hover min-height-160 min-height-160">
                                <img src="./assets2/img/groot-tech-logos/groot-academy-spring-framework-logo.png" width="100%">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-6 mt-md-0">
                        <a href="./digitalmarkating">
                            <div class="card shadow-lg move-on-hover min-height-160 min-height-160">
                                <img src="./assets2/img/course-card-images/Digital_Marketing2.png" width="100%">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-6 mt-md-0">
                        <a href="./best-android-application-development-course-in-jaipur">
                            <div class="card shadow-lg move-on-hover min-height-160 min-height-160">
                                <center>
                                    <img src="./assets2/img/groot-academy-android.png" width="40%">
                                </center>
                                <b style="text-align: center; font-size:medium; margin-top:32px;">Android Developement</b>
                            </div>
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-6 mt-md-0">
                        <a href="./best-android-application-development-course-in-jaipur">
                            <div class="card shadow-lg move-on-hover min-height-160 min-height-160">
                                <center>
                                    <img src="./assets2/img/groot-academy-ios.png" width="50%">
                                </center>
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-6 mt-md-0">
                        <a href="./best-hybrid_application_development-course-in-jaipur">
                            <div class="card shadow-lg move-on-hover min-height-160 min-height-160">
                                <center>
                                    <img src="./assets2/img/GroothybridAppDevelopment.png" width="100%">
                                </center>
                                <b style="text-align: center;margin-top: 33px; font-size:medium;">Hybrid App Developement</b>
                            </div>
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-6 mt-md-0">
                        <a href="./best-flutter-application_development-course-in-jaipur">
                            <div class="card shadow-lg move-on-hover min-height-160 min-height-160">
                                <center>
                                    <img src="./assets2//img/grootFlutterlogo.png" width="120%">
                                </center>
                                <b style="text-align: center; font-size:medium;">Flutter App development
                                </b>
                            </div>
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-6 mt-2">
                        <a href="./best-react-native-application-development-course-in-jaipur">
                            <div class="card shadow-lg move-on-hover min-height-160 min-height-160">
                                <center>
                                    <img src="./assets2/img/groot-react-native-logo.webp" width="50%">
                                </center>
                                <b style="text-align: center; font-size:medium;margin-top:3px;">React Native App development
                                </b>
                            </div>
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-6 mt-2">
                        <a href="./best-data-analytics-course-using-python-in-jaipur">
                            <div class="card shadow-lg move-on-hover min-height-160 min-height-160">
                                <center>
                                    <img src="./assets2/img/course-card-images/Data-Analytics-with-python-course-in-noida.jpg.webp" width="100%">
                                </center>
                                <b style="text-align: center; font-size:medium;margin-top:5px;">Data Analitics
                                </b>
                            </div>
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-6 mt-2">
                        <a href="./best-data-science-course-using-python-in-jaipur">
                            <div class="card shadow-lg move-on-hover min-height-160 min-height-160">
                                <center>
                                    <img src="./assets2/img/course-card-images/Data-Science.png" width="100%">
                                </center>
                                <b style="text-align: center;  margin-top: 44px; font-size:medium;">Data Science
                                </b>
                            </div>
...
<div class="col-lg-12 col-sm-12 col-xs-12 px-lg-1 mt-lg-0 mt-4">
    <div class="info-horizontal bg-gradient-primary border-radius-xl p-5">
        ...
        <div class="description ps-0 text-light">
            ...
            <button class="bg-gradient-primary ps-10 btn btn-primary"><a style="background-image: linear-gradient(310deg, #0c4e99 50%, #0c4e99 50%);  " href="./enroll" class="text-white icon-move-right bg-">
...
<script src="./assets2/js/plugins/countup.min.js"></script>
<!--  Plugin for Parallax, full documentation here: https://github.com/dixonandmoe/rellax -->
<script src="./assets2/js/plugins/rellax.min.js"></script>
<!--  Plugin for TiltJS, full documentation here: https://gijsroge.github.io/tilt.js/ -->
<script src="./assets2/js/plugins/tilt.min.js"></script>
