    ...
    <div class="row">
        <div class="col-lg-12 mx-auto">
            <div class="mb-4 w-100">
                ...
                <h4 class="course-heading"><img src="./assets2/img//groot-react-native-logo.webp" alt="image" width="50" style="border-radius: 10px;" /> React Native Application Development</h4>
            </div>
