...
"master-in-reactjs",
"project-training-internship-in-mern",
"project-training-internship-in-java",
"data-analytics",
"machine-learning",
"artificial-intelligence",
"software-engineering-diploma",
"data-science-machine-learning-diploma",
"master-core-advance-javascript-es6-es10",
"wordpress-shopify-training",
"mobile-app-dev-android-kotlin",
"mobile-app-dev-ios-swift",
...
template = """<?php
                ...
                $page_url = "https://grootacademy.com/{course_name}.php";
                ?>
...
<div class="main-content">
    ...
    <footer id="rs-footer" class="rs-footer home9-style main-home">
        ...
        # Generate the filename based on the course name
        filename = f"{course}.php"

        # Write the course-specific PHP file
        with open(filename, "w") as file:
        file.write(template.format(course_name=course))

        print("PHP pages generated successfully!")