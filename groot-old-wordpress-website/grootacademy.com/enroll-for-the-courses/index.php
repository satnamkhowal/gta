...
$page_url = "https://grootacademy.com/graphics-designing.php";
?>
...
<div class="main-content">
    ...
    <div class="rs-breadcrumbs breadcrumbs-overlay">
        ...
        <div class="breadcrumbs-text white-color">
            <h1 class="page-title">Allotment</h1>
            <ul>
                <li>
    ...
    <div class="form_text_index">
        <h3>Master Data Structures and Algorithms With the groot Academy Program</h3>
        <ul>
            <li>1. Secure product interviews with understanding of crucial data structures and algorithms, and their implementation.</li>
            <li>2. Build intuition on the inner workings of various DSA, a foundational skill for any top software engineer.</li>
            <li>
    ...
    <div class="course_from">
        <a href="<?php echo FINAL_WEBSITE_URL; ?>courses/core-java-j2se.php">
            <button class="course_box">
                Core Java
            </button>
        </a>
        <a href="<?php echo FINAL_WEBSITE_URL; ?>courses/advance-java.php">
            <button class="course_box">
                Advance Java
            </button>
        </a>
        <a href="<?php echo FINAL_WEBSITE_URL; ?>courses/artificial-intelligence.php">
            <button class="course_box">
                Artificial Intelligence
            </button>
        </a>
        <a href="<?php echo FINAL_WEBSITE_URL; ?>courses/backend-architecture-with-nodejs.php">
            <button class="course_box">
                Backend Architecture With Nodejs
            </button>
        </a>
        <a href="<?php echo FINAL_WEBSITE_URL; ?>courses/c-programming.php">
            <button class="course_box">
                C Programming
            </button>
        </a>
        <a href="<?php echo FINAL_WEBSITE_URL; ?>courses/cpp-programming.php">
            <button class="course_box">
                C+ Programming </button>
        </a>
        <a href="<?php echo FINAL_WEBSITE_URL; ?>courses/data-analytics.php">
            <button class="course_box">
                Data Analytics </button>
        </a>
        <a href="<?php echo FINAL_WEBSITE_URL; ?>courses/data-science-machine-learning-diploma.php">
            <button class="course_box">
                Data Science Machine Learning Diploma </button>
        </a>
        <a href="<?php echo FINAL_WEBSITE_URL; ?>courses/digital-marketing.php">
            <button class="course_box">
                Digital marketing </button>
        </a>
        <a href="<?php echo FINAL_WEBSITE_URL; ?>courses/full-stack-web-development-with-java.php">
            <button class="course_box">
                Full stack web Development </button>
        </a>

        <a href="<?php echo FINAL_WEBSITE_URL; ?>courses/graphics-designing.php">
            <button class="course_box">
                Graphics Designing </button></a>
        <a href="<?php echo FINAL_WEBSITE_URL; ?>courses/java-spring-framework.php">
            <button class="course_box">
                Java frameworks spring boot hibernate</button>
        </a>
        <a href="<?php echo FINAL_WEBSITE_URL; ?>courses/diploma-in-machine-learning.php">
            <button class="course_box">
                Machine learning</button>
        </a>
        <a href="<?php echo FINAL_WEBSITE_URL; ?>courses/backbone-js.php">
            <button class="course_box">
                Master core advance javascript Es6-Es10</button>
        </a>
        <a href="<?php echo FINAL_WEBSITE_URL; ?>courses/react-js.php">
            <button class="course_box">
                Master in Reactjs</button>
        </a>
        <a href="<?php echo FINAL_WEBSITE_URL; ?>courses/mobile-application-development-with-android-kotlin.php">
            <button class="course_box">
                Mobile app dev android kotlin</button>
        </a>
        <a href="<?php echo FINAL_WEBSITE_URL; ?>courses/mobile-app-dev-ios-swift.php">
            <button class="course_box">
                Mobile app dev ios swift</button>
        </a>
        <a href="<?php echo FINAL_WEBSITE_URL; ?>courses/core-java-j2se.php">
            <button class="course_box">
                Project training internship in java</button>
        </a>
        <a href="<?php echo FINAL_WEBSITE_URL; ?>courses/core-java-j2se.php">
            <button class="course_box">
                Project training internship in mern</button>
        </a>
        <a href="<?php echo FINAL_WEBSITE_URL; ?>courses/core-java-j2se.php">
            <button class="course_box">
        ...
        <a href="<?php echo FINAL_WEBSITE_URL; ?>courses/core-java-j2se.php">
            <button class="course_box">
                Software engineering diploma</button>
        </a>
        <a href="<?php echo FINAL_WEBSITE_URL; ?>courses/web-designing.php">
            <button class="course_box">
                web designing</button>
        </a>
        <a href="<?php echo FINAL_WEBSITE_URL; ?>courses/core-java-j2se.php">
            <button class="course_box">
                Wordpress shopify training</button>
        </a>
    </div>


    <!-- Breadcrumbs End -->
    <div class="main-oracle">
    ...
    <footer id="rs-footer" class="rs-footer home9-style main-home">
        ...
        <!-- Mirrored from keenitsolutions.com/products/html/educavo/course3.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Aug 2023 08:02:08 GMT -->
