    ...
    <div class="row">
        <div class="col-lg-12 mx-auto">
            <div class="mb-4 w-100">
                ...
                <h4 class="course-heading"><img src="./assets2/img/java.png" alt="image" width="50" style="border-radius: 10px;" /> JAVA Full Stack Developer | Full Stack Developer Course | JAVA Full Stack Developer Training</h4>
            </div>
