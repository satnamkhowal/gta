...
class WP_Events_Manager extends Widget_Base {
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                'type'         => Controls_Manager::SWITCHER,
                'label'        => __( 'Event Price', 'edubin-core' ),
                'label_on'     => __( 'Enable', 'edubin-core' ),
                'label_off'    => __( 'Disable', 'edubin-core' ),
                'default'      => 'yes',
                'return_value' => 'yes',
    ...
    protected function render() {
       ...
       // ===== End Only for style 02 header section =====
        ...
        $wp_query = new \WP_Query( Helper::wpem_query_args( $settings, $this->post_type, $this->category_taxonomy ) );
            ...
            echo '<div ' . $this->get_render_attribute_string( 'wrapper' ) . '>';
                echo '<div ' . $this->get_render_attribute_string( 'container' ) . '>';
                    ...
                    while ( $wp_query->have_posts() ) { $wp_query->the_post();
                        ...
                        $enable_price = $settings['enable_price'];
