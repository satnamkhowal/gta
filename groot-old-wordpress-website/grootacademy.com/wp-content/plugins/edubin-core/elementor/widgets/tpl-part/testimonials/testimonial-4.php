...
$quote_bg_color = (isset($settings['quote_bg_color']) && $settings['quote_bg_color'] != '') ? $settings['quote_bg_color'] : 'var(--edubin-primary-color)';
$quote_icon_color = (isset($settings['quote_icon_color']) && $settings['quote_icon_color'] != '') ? $settings['quote_icon_color'] : '#fff';
