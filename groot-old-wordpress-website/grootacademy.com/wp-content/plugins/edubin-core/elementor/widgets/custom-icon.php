        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '.rtl {{WRAPPER}}.elementor-position-right .elementor-icon-box-icon' => 'margin-right: {{SIZE}}{{UNIT}}; margin-left: 0;',
                    '.rtl {{WRAPPER}}.elementor-position-left .elementor-icon-box-icon' => 'margin-left: {{SIZE}}{{UNIT}}; margin-right: 0;',
