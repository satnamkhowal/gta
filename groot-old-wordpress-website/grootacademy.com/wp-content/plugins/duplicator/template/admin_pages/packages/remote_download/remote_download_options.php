...
<div id="dup-remote-package-download">
    <form method="POST" action="">
        ...
        <?php /* action key + nonce are injected by the opening page's JS (see remote_download/scripts.php). */ ?>
        ...
        <p>
            ...
            printf(
                wp_kses(
                    __('The <b>%s</b> backup isn\'t in local storage, it\'s possible to download it to the local server.', 'duplicator'),
                    [
                        'b' => [],
                    ]
                ),
