...
?>
<div
    class="dynamic-sub-note dynamic-sub-note-<?php echo DUPX_Extraction::ACTION_DO_NOTHING .
                                                    ($currentAction == DUPX_Extraction::ACTION_DO_NOTHING ? '' : ' no-display'); ?>">
...
<div
    class="dynamic-sub-note dynamic-sub-note-<?php echo DUPX_Extraction::ACTION_REMOVE_ALL_FILES .
                                                    ($currentAction == DUPX_Extraction::ACTION_REMOVE_ALL_FILES ? '' : ' no-display'); ?>">
...
<div
    class="dynamic-sub-note dynamic-sub-note-<?php echo DUPX_Extraction::ACTION_REMOVE_UPLOADS .
                                                    ($currentAction == DUPX_Extraction::ACTION_REMOVE_UPLOADS ? '' : ' no-display'); ?>">
...
<div
    class="dynamic-sub-note dynamic-sub-note-<?php echo DUPX_Extraction::ACTION_REMOVE_WP_FILES .
                                                    ($currentAction == DUPX_Extraction::ACTION_REMOVE_WP_FILES ? '' : ' no-display'); ?>">
    Note: Before extracting the package files, 
    <b>all current WordPress core and content files and folders will be removed</b> (wp-includes, wp-content ... )<br>
    This option is for those who want to avoid having old site media mixed with new but have other files/folders
    in the home path that they don't want to delete.
</div>