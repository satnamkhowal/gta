 ...
 *
 * [archive] to set the custom folder that contains the archive
 * the archive file name always comes from the embedded package hash, not from this value
 *      installer.php?archive=[archive folder]
 */
