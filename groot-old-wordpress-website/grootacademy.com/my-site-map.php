...
<div class="main-content">
    ...
    <div class="rs-breadcrumbs breadcrumbs-overlay">
        ...
        <div class="breadcrumbs-text white-color">
            ...
            <ul>
                <li>
                    <a class="active" href="<?php echo FINAL_WEBSITE_URL; ?>#">Home</a>
                </li>
                <li>About Us</li>
            </ul>
        </div>
                    ...
                    <div class="row rs-counter couter-area">
                        <div class="col-md-4 sm-mb-30">
                            <div class="counter-item one">
                                <img class="count-img" src="<?php echo FINAL_WEBSITE_URL; ?>assets/images/about/style3/icons/1.png" alt="">
                        ...
                        <div class="col-md-4 sm-mb-30">
                            <div class="counter-item two">
                                <img class="count-img" src="<?php echo FINAL_WEBSITE_URL; ?>assets/images/about/style3/icons/2.png" alt="">
                        ...
                        <div class="col-md-4">
                            <div class="counter-item three">
                                <img class="count-img" src="<?php echo FINAL_WEBSITE_URL; ?>assets/images/about/style3/icons/3.png" alt="">
    ...
    <div id="rs-about-video" class="rs-about-video pt-100 pb-100 md-pt-70 md-pb-70">
        <div class="container">
            <div class="video-img-part media-icon orange-color2">
                <img src="<?php echo FINAL_WEBSITE_URL; ?>assets/images/about/about-video-bg-orange.png" alt="Video Bg Image">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 col-sm-6 mb-30">
                    <div class="team-item">
                        <img src="<?php echo FINAL_WEBSITE_URL; ?>assets/images/team/1.jpg" alt="">
                        <div class="content-part">
                            <h4 class="name"><a href="<?php echo FINAL_WEBSITE_URL; ?>team-single.html">Jhon Pedrocas</a></h4>
                ...
                <div class="col-lg-4 col-sm-6 mb-30">
                    <div class="team-item">
                        <img src="<?php echo FINAL_WEBSITE_URL; ?>assets/images/team/2.jpg" alt="">
                        <div class="content-part">
                            <h4 class="name"><a href="<?php echo FINAL_WEBSITE_URL; ?>team-single.html">Jhon Pedrocas</a></h4>
                            <span class="designation">Professor</span>
                            <ul class="social-links">
                ...
                <div class="col-lg-4 col-sm-6 mb-30">
                    <div class="team-item">
                        <img src="<?php echo FINAL_WEBSITE_URL; ?>assets/images/team/3.jpg" alt="">
                        <div class="content-part">
                            <h4 class="name"><a href="<?php echo FINAL_WEBSITE_URL; ?>#">Jhon Pedrocas</a></h4>
                            <span class="designation">Professor</span>
                            <ul class="social-links">
                                <li><a href="<?php echo FINAL_WEBSITE_URL; ?>#"><i class="fa fa-facebook"></i></a></li>
                                <li><a href="<?php echo FINAL_WEBSITE_URL; ?>#"><i class="fa fa-twitter"></i></a></li>
            ...
            <div class="rs-carousel owl-carousel" data-loop="true" data-items="2" data-margin="30" data-autoplay="true" data-hoverpause="true" data-autoplay-timeout="5000" data-smart-speed="800" data-dots="true" data-nav="false" data-nav-speed="false" data-center-mode="false" data-mobile-device="1" data-mobile-device-nav="false" data-mobile-device-dots="false" data-ipad-device="2" data-ipad-device-nav="false" data-ipad-device-dots="false" data-ipad-device2="2" data-ipad-device-nav2="false" data-ipad-device-dots2="false" data-md-device="2" data-md-device-nav="false" data-md-device-dots="true">
                <div class="testi-item">
                    <div class="row y-middle no-gutter">
                        <div class="col-md-4">
                            <div class="user-info">
                                <img src="<?php echo FINAL_WEBSITE_URL; ?>assets/images/testimonial/style3/1.png" alt="">
                ...
                <div class="testi-item">
                    <div class="row y-middle no-gutter">
                        <div class="col-md-4">
                            <div class="user-info">
                                <img src="<?php echo FINAL_WEBSITE_URL; ?>assets/images/testimonial/style3/2.png" alt="">
                                <h4 class="name">Saiko Najran</h4>
                                <span class="designation">Student</span>
                                <ul class="ratings">
                                    <li><i class="fa fa-star"></i></li>
                ...
                <div class="testi-item">
                    <div class="row y-middle no-gutter">
                        <div class="col-md-4">
                            <div class="user-info">
                                <img src="<?php echo FINAL_WEBSITE_URL; ?>assets/images/testimonial/style3/3.png" alt="">
                                <h4 class="name">Saiko Najran</h4>
                                <span class="designation">Student</span>
                                <ul class="ratings">
                                    <li><i class="fa fa-star"></i></li>
                ...
                <div class="testi-item">
                    <div class="row y-middle no-gutter">
                        <div class="col-md-4">
                            <div class="user-info">
                                <img src="<?php echo FINAL_WEBSITE_URL; ?>assets/images/testimonial/style3/4.png" alt="">
                                <h4 class="name">Saiko Najran</h4>
                                <span class="designation">Student</span>
                                <ul class="ratings">
                                    <li><i class="fa fa-star"></i></li>
                ...
                <div class="testi-item">
                    <div class="row y-middle no-gutter">
                        <div class="col-md-4">
                            <div class="user-info">
                                <img src="<?php echo FINAL_WEBSITE_URL; ?>assets/images/testimonial/style3/5.png" alt="">
                                <h4 class="name">Saiko Najran</h4>
                                <span class="designation">Student</span>
                                <ul class="ratings">
                                    <li><i class="fa fa-star"></i></li>
                ...
                <div class="testi-item">
                    <div class="row y-middle no-gutter">
                        <div class="col-md-4">
                            <div class="user-info">
                                <img src="<?php echo FINAL_WEBSITE_URL; ?>assets/images/testimonial/style3/6.png" alt="">
                                <h4 class="name">Saiko Najran</h4>
                                <span class="designation">Student</span>
                                <ul class="ratings">
                                    <li><i class="fa fa-star"></i></li>
                ...
                <div class="testi-item">
                    <div class="row y-middle no-gutter">
                        <div class="col-md-4">
                            <div class="user-info">
                                <img src="<?php echo FINAL_WEBSITE_URL; ?>assets/images/testimonial/style3/7.png" alt="">
                                <h4 class="name">Saiko Najran</h4>
                                <span class="designation">Student</span>
                                <ul class="ratings">
                                    <li><i class="fa fa-star"></i></li>
                ...
                <div class="testi-item">
                    <div class="row y-middle no-gutter">
                        <div class="col-md-4">
                            <div class="user-info">
                                <img src="<?php echo FINAL_WEBSITE_URL; ?>assets/images/testimonial/style3/8.png" alt="">
                                <h4 class="name">Saiko Najran</h4>
                                <span class="designation">Student</span>
                                <ul class="ratings">
                                    <li><i class="fa fa-star"></i></li>
                ...
                <div class="testi-item">
                    <div class="row y-middle no-gutter">
                        <div class="col-md-4">
                            <div class="user-info">
                                <img src="<?php echo FINAL_WEBSITE_URL; ?>assets/images/testimonial/style3/9.png" alt="">
                                <h4 class="name">Saiko Najran</h4>
                                <span class="designation">Student</span>
                                <ul class="ratings">
                                    <li><i class="fa fa-star"></i></li>
                ...
                <div class="testi-item">
                    <div class="row y-middle no-gutter">
                        <div class="col-md-4">
                            <div class="user-info">
                                <img src="<?php echo FINAL_WEBSITE_URL; ?>assets/images/testimonial/style3/10.png" alt="">
                                <h4 class="name">Saiko Najran</h4>
                                <span class="designation">Student</span>
                                <ul class="ratings">
                                    <li><i class="fa fa-star"></i></li>
            ...
            <div class="row">
                <div class="col-lg-7 pr-60 md-pr-15 md-mb-30">
                    <div class="row no-gutter white-bg blog-item mb-35">
                        <div class="col-md-6">
                            <div class="image-part">
                                <a href="<?php echo FINAL_WEBSITE_URL; ?>#"><img src="<?php echo FINAL_WEBSITE_URL; ?>assets/images/blog/style3/1.jpg" alt=""></a>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="blog-content">
                                ...
                                <h3 class="title"><a href="<?php echo FINAL_WEBSITE_URL; ?>blog-single.html">Modern School The Lovely Valley Team Work</a></h3>
                                <div class="btn-part">
                                    <a class="readon-arrow" href="<?php echo FINAL_WEBSITE_URL; ?>#">Read More</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row no-gutter white-bg blog-item">
                        <div class="col-md-6 order-last">
                            <div class="image-part">
                                <a href="<?php echo FINAL_WEBSITE_URL; ?>#"><img src="<?php echo FINAL_WEBSITE_URL; ?>assets/images/blog/style3/2.jpg" alt=""></a>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="blog-content">
                                ...
                                <h3 class="title"><a href="<?php echo FINAL_WEBSITE_URL; ?>blog-single.html">High School Program Starting Soon 2021</a></h3>
                                <div class="btn-part">
                                    <a class="readon-arrow" href="<?php echo FINAL_WEBSITE_URL; ?>#">Read More</a>
                                </div>
                            </div>
                ...
                <div class="col-lg-5 lg-pl-0">
                    <div class="events-short mb-28">
                        ...
                        <div class="content-part">
                            <div class="categorie">
                                <a href="<?php echo FINAL_WEBSITE_URL; ?>#">Math</a> & <a href="<?php echo FINAL_WEBSITE_URL; ?>#">English</a>
                            </div>
                            <h4 class="title mb-0"><a href="<?php echo FINAL_WEBSITE_URL; ?>blog-single.html">Educational Technology and Mobile Accessories Learning</a></h4>
                        </div>
                    </div>
                    <div class="events-short mb-28">
                        ...
                        <div class="content-part">
                            <div class="sec-title">
                                <div class="title-icon md-mb-15">
                                    <img src="<?php echo FINAL_WEBSITE_URL; ?>assets/images/newsletter.png" alt="images">
                                </div>
