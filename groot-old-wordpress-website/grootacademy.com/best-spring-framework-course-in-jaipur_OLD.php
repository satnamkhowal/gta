          ...
          <div class="row">
            <div class="col-md -6">
              <div class="form-floating">
                ...
                <label style="color: black" class="mt-2 text-lg" for="floatingSelect">What is Spring Framework?</label>
              </div>
              <div class="form-floating">
                <select class="form-select" id="floatingSelect" aria-label="Floating label select example">
                ...
                <label style="color: black" class="mt-2 text-lg" for="floatingSelect">Spring Core Concepts - DI, IoC, AOP</label>
              </div>
              <div class="form-floating">
                <select class="form-select" id="floatingSelect" aria-label="Floating label select example">
                ...
                <label style="color: black" class="mt-2 text-lg" for="floatingSelect">Spring Framework Core Components</label>
              </div>
            ...
            <div class="col-md -6">
              <div class="form-floating">
                ...
                <label style="color: black" class="mt-2 text-lg" for="floatingSelect">Spring Framework Web</label>
              </div>
              ...
              <div class="form-floating">
                ...
                <label style="color: black" class="mt-2 text-lg" for="floatingSelect">Spring Framework Data Access</label>
              </div>
              <div class="form-floating">
                <select class="form-select" id="floatingSelect" aria-label="Floating label select example">
                ...
                <label style="color: black" class="mt-2 text-lg" for="floatingSelect">Miscellaneous Modules</label>
              </div>
