...
<title>Full stack Web development with NodeJS(MERN : Mongo DB, ExpressJS, ReactJS, NodeJS stack Web development), Java,
  ReactJS , AngularJS, VueJs, Web desinging, data analyst, Python, C and C++ programming, Data Science Certification &
  Training Course - Groot Academy</title>
...
<meta name="author"
  content="Groot Academy Pvt Ltd, Software Development, Web Desinging and Development Training Center" />
...
<header class="bg-gradient-dark">
  <div class="page-header min-vh-75" style="background-image: url('./assets2/img/office-dark.jpg');">
      ...
      <div class="row justify-content-center">
        <div class="col-lg-8 text-center mx-auto my-auto">
          ...
          <p class="lead mb-4 text-white opacity-8">We’re constantly trying to express ourselves and actualize our
            dreams. If you want to connect with us </p>
          <h6 class="text-white mb-2 mt-5">Find us on</h6>
          <div class="d-flex justify-content-center">
            <a class="nav-link pe-1" href="https://facebook.com/grootAcademy" target="_blank"><i
                class="fa fa-facebook text-lg text-white me-4"></i></a>
            <a class="nav-link pe-1" href="https://instagram.com/grootAcademy" target="_blank"><i
                class="fa fa-instagram text-lg text-white me-4"></i></a>
            <a class="nav-link pe-1" href="https://twitter.com/grootAcademy" target="_blank"><i
                class="fa fa-twitter text-lg text-white me-4"></i></a>
            <a class="nav-link pe-1" href="https://www.grootacademy.com/" target="_blank"><i
                class="fa fa-google-plus text-lg text-white"></i></a>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="row justify-content-start">
          <div class="col-md-6">
            <div class="info">
              ...
              <h5>Educate</h5>
              <p>Education is a purposeful activity directed at achieving certain aims, such as transmitting knowledge
                or fostering skills and character traits.</p>
            </div>
          </div>
          <div class="col-md-6">
            <div class="info">
              ...
              <h5>Practice</h5>
              <p>Level up your programming skills with our comprehensive guide containing interview questions, practice
                problems, coding challenges and alot more.</p>
            </div>
          </div>
        </div>
        <div class="row justify-content-start">
          <div class="col-md-6">
            <div class="info">
              ...
              <p>Implementation is often used in the tech world to describe the interactions of elements in programming
                languages. </p>
            </div>
          </div>
          <div class="col-md-6">
        ...
        <div class="card shadow-lg">
          <div class="card-header p-0 mx-3 mt-3 position-relative z-index-1">
            <div class="d-block blur-shadow-image">
              <img src="./assets2/img/group.jpg" alt="img-blur-shadow" class="img-fluid shadow rounded-3">
            </div>
            <div class="colored-shadow" style="background-image: url(&quot;./assets2/img/funny.jpg&quot;);"></div>
          </div>
          <div class="card-body">
            <a href="javascript:;">
              <h5 class="mt-3">
            ...
            <p>
              We are the modern-day IT training institute, dedicated to deliver the best coding knowledge to today’s
              passionate and innovative programming aspirants like yourself. Our programming courses not only make you
              job-ready but we also work upon your creative thinking. Students here don’t learn how to be coding
              machines, but actually how to get their creative juices flowing, stand out in the crowd and make a
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-8 text-start mb-5 mt-5">
        <h3 class="text-white z-index-1 position-relative">The Executive Team at Mansarovar Branch</h3>
    ...
    <div class="row">
        ...
        <a class="card-wrapper" href="./profile-page/JITIN-SIR.html">
          <div class="card3">
            <div class="card-image1">
              <img class="w-100" src="./assets2/img/profileImages/divya-image-for-website2.jpg" alt="">
            </div>
            <div class="details1">
              <h2>JAYA GANGWANI</h2>
              <p>Center Head and HR </p>
              <ul>
                <li>
                  <a href="">
      ...
      <div class="col-lg-8 col-12 mt-5">
        ...
        <p class="text-white opacity-8 mb-0"><strong>Contact No:</strong> <a href="tel:+91-8690047091"><i
              class="mt-0 fa fa-mobile me-2" style="color: #fff;" aria-hidden="true"></i> +91-8690047091</a></p>
    ...
    <div class="row">
      <div class="col-lg-4 col-12">
        <a class="card-wrapper" href="./profile-page/JITIN-SIR.html">
          <div class="card3">
            <div class="card-image1">
              <img class="w-100" src="./assets2/img/profileImages/jatin-goyal-sir.jpg" alt="">
            </div>
            <div class="details1">
              <h2>Jitin Goyal</h2>
      ...
      <div class="col-lg-4 col-12">
        <a class="card-wrapper" href="./profile-page/BHASKAR-SIR.html">
          <div class="card3">
            <div class="card-image1">
              <img class="w-100 bg-white" src="./assets2/img/profileImages/bhaskar-sir.JPEG" alt="">
            </div>
            <div class="details1">
              <h2>Bhaskar Yogi</h2>
      ...
      <div class="col-lg-4 col-12">
        <a class="card-wrapper" href="./profile-page/SATNAM-SIR.html">
          <div class="card3">
            <div class="card-image1">
              <img class="w-100 h-100" src="./assets2/img/profileImages/satnam_sir.jpg" alt="">
            </div>
            <div class="details1">
              <h2>Satnam Singh</h2>
    ...
    <div class="row mt-4">
      <div class="col-lg-4 col-12">
        <a class="card-wrapper" href="./profile-page/ANKIT-SIR.html">
          <div class="card3">
            <div class="card-image1">
              <img class="w-100 h-100" src="./assets2/img/profileImages/ankit-sir.JPEG" alt="profileImage">
            </div>
            <div class="details1">
              <h2>ankit swami</h2>
              <p>Web Developer</p>
      ...
      <div class="col-lg-4 col-12">
        <a class="card-wrapper" href="./profile-page/DEEPENDRA-SIR.html">
          <div class="card3">
            <div class="card-image1">
              <img class="w-100 h-100" src="./assets2/img/profileImages/deependra-sir.png" alt="">
            </div>
            <div class="details1">
      ...
      <div class="col-lg-4 col-12">
        <a class="card-wrapper" href="./profile-page/PAWAN-SIR.html">
          <div class="card3">
            <div class="card-image1">
              <img class="w-100 h-100" src="./assets2/img/profileImages/pawan-sir.JPEG" alt="">
            </div>
            <div class="details1">
    ...
    <div class="row mt-4">
      <div class="col-lg-6 col-12">
        <a class="card-wrapper" href="./profile-page/MOHIT-SIR.html">
          <div class="card3">
            <div class="card-image1">
              <img class="w-100 h-100" src="./assets2/img/profileImages/mohit_sir.jpg" alt="">
            </div>
            <div class="details1">
              <h2>Mohit Sharma</h2>
              <p>Web Developer</p>
      ...
      <div class="col-lg-6 col-12">
        <a class="card-wrapper" href="./profile-page/SNDEEP-SIR.html">
          <div class="card3">
            <div class="card-image1">
              <img class="w-100 h-100" src="./assets2/img/profileImages/sandeep_sir.jpg" alt="">
            </div>
            <div class="details1">
      ...
      <div class="carousel-inner" role="listbox">
        <div class="carousel-item active">
          <div class="col-md-3">
            <div class="card">
              <div class="card-img">
                <img src="images2/style2/1.png" width="200" class="">
              </div>
        ...
        <div class="carousel-item">
          <div class="col-md-3">
            <div class="card">
              <div class="card-img">
                <img src="images2/style2/2.png" width="200">
              </div>
        ...
        <div class="carousel-item">
          <div class="col-md-3">
            <div class="card">
              <div class="card-img">
                <img src="images2/style2/3.png" width="200">
              </div>
        ...
        <div class="carousel-item">
          <div class="col-md-3">
            <div class="card">
              <div class="card-img">
                <img src="images2/style2/4.png" width="200">
              </div>
        ...
        <div class="carousel-item">
          <div class="col-md-3">
            <div class="card">
              <div class="card-img logo-img">
                <img src="images2/style2/5.png" width="180" alt="">
                <a>
        ...
        <div class="carousel-item">
          <div class="col-md-3">
            <div class="card">
              <div class="card-img">
                <img src="images2/style2/6.png" width="200">
              </div>
