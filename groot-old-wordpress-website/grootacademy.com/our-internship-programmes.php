    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-7 text-center mx-auto">
          <h1 class="text-white pt-3 mt-n5">All Internship Programmes</h1>
      ...
      <div class="col-lg-12 ms-auto me-auto p-lg-0  mt-0">
        <div class="card  card-background-mask-primary tilt" data-tilt style="background-image: linear-gradient(310deg, #0c4e99 50%, #0c4e99 50%);">
          ...
          <div class="card-body pt-4 text-center">
            ...
            <h1 class="up mb-0"> Internship FEATURES</h1><br><br>
        ...
        <div class="row">
          ...
          <div class="col-md-4 col-sm-6 col-xs-6 mt-md-0">
            <a href="./best-web-designing-course-in-jaipur">
              <div class="card shadow-lg move-on-hover min-height-160 min-height-160">
                <img src="./assets2/img/course-card-images/web desiging1.avif" width="100%">
